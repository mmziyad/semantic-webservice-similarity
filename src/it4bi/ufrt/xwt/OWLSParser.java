...
public class OWLSParser {
	...
	public String extractProcessInput() {
		...
		if (nodeList.getLength() != 0) {
			...
			input = input.replace(Properties.XML_BASE, "");
			input += "\n";
		}
	...
	public String extractProcessPreConditions() {
		...
		if (nodeList.getLength() != 0) {
			...
			preConditions = preConditions.replace(Properties.XML_BASE, "");
		}
		return preConditions;
	}
	...
	public String extractProcessOutput() {
		...
		if (nodeList.getLength() != 0) {
			...
			output = output.replace(Properties.XML_BASE, "");
			output += "";
		}
		return output;
	}
	...
	public String extractProcessResults() {
		...
		if (nodeList.getLength() != 0) {
			...
			results = results.replace(Properties.XML_BASE, "");
		}
		return results;
	}
} // End of Document