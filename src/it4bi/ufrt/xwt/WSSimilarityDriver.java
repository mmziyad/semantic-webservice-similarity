...
public class WSSimilarityDriver extends JPanel implements ActionListener {

	private static final long serialVersionUID = 1L;

	/** This class opens a standard file-requester to select an owls-file */

	public WSSimilarityDriver() {
		...
		fc = new JFileChooser("/Users/zis/Desktop/EXAMPLES");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == openButton1) {
			returnVal = fc.showOpenDialog(WSSimilarityDriver.this);
		...
		if (file1 != null && file2 != null) {
			new WSSmilarityCore(file1.getAbsolutePath(), file2.getAbsolutePath());
		}
	}
	...
	private static void createAndShowGUI() {
		...
		JComponent newContentPane = new WSSimilarityDriver();
